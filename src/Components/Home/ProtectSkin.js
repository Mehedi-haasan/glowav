        ...
        <div className="px-5 md:px-10 lg:px-28 xl:px-44 2xl:px-[300px]">
            <div className="flex justify-between items-center py-5 pb-6 lg:pb-10">
                ...
                <div className="flex justify-end items-center gap-4">
                    ...
                    <svg width="56" height="56" onClick={nextState} className="h-[25px] w-[25px] md:h-[30px] md:w-[30px] lg:h-[40px] lg:w-[40px] xl:h-[56px] xl:w-[56px]" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
            <div className="">
                <Slider {...settings} ref={sliderRef}>
                    <div className="mx-2">
                        <img src={care} alt="gkdhf" className="h-[400px] w-full px-2" />
                    </div>
                    <div className="mx-2">
                        <img src={image2} alt="gkdhf" className="h-[400px] w-full px-2" />
                    </div>
                    <div className="mx-2">
                        <img src={care} alt="gkdhf" className="h-[400px] w-full px-2" />
                    </div>
